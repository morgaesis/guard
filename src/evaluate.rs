use crate::gating::allow_promotion::{self, AllowPromotionOutcome, AllowPromotionStore};
...
const SYSTEM_PROMPT_CONFIRM_VERB_PROMOTION: &str = "A guard daemon derived a candidate verb \
