...
```powershell
$archive = Resolve-Path '.\guard-v0.8.6-x86_64-pc-windows-msvc.tar.gz'
...
$archiveRoot = 'C:\ProgramData\GuardInstall\guard-v0.8.6-x86_64-pc-windows-msvc'
