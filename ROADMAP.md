...
- Function-calling primary path with `openai/gpt-5.4-mini` as the default model (100% accuracy on the 45-case benchmark, ~2.6x cheaper and ~39% faster than the previous Gemini 3 Flash baseline).
